...
!------------------------------------------------------------------
    ...
    write(iow03,"(4e12.4)") CurrentTime, EngKinetic+EngInternal, EngKinetic, EngInternal
    write(iow04,"(4e12.4)") CurrentTime, Mombody1(1), Mombody1(2), Mombody1(3)

    if (contact) then
        ! output contact force
        write(iow05,"(4e12.4)") CurrentTime, tot_cont_for(1), tot_cont_for(2), tot_cont_for(3) 
    end if
