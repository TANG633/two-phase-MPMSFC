...
! -----------------------------------------------------------------
    ...
    if (xx(1) < SpanX(1) .or. xx(1) > SpanX(2) .or. &
        xx(2) < SpanY(1) .or. xx(2) > SpanY(2) .or. &
        xx(3) < SpanZ(1) .or. xx(3) > SpanZ(2)) then
        idx = -1
        idy = -1
        idz = -1
    else
    ...
    ! Only update if the cell is valid 
...
!------------------------------------------------------------------
    ...
    do i = 1, 3
        ...
        elseif (node1(i) == gn%NumNode(i)-1) then
